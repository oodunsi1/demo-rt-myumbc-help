<?php
//apcu_clear_cache();
//echo "<pre>" . print_r(apcu_cache_info(), true) . "</pre>";
...
?>
    ...
    <title> UMBC Help - UMBC: An Honors University in Maryland </title>
...
{
?>
    <span style="position:absolute;float:top;left:50vw;top:0;color:lime;font-weight:bold;border:2px;border-color:white"><?php echo $devMode; ?></span>
<?php
}
?>
</nav>
...
<div class="container-fluid py-2 border-end border-start border-bottom rounded-bottom umbcHelpFormContainer" <?php echo ($embedMode ? "style=\"border-bottom: 0; width:100%; height:100%; position:fixed; overflow-y: hidden\"" : ""); ?>>
    <div class="py-0 my-0" <?php echo ($embedMode ? "style=\"overflow-y: auto\"" : "");?>>
        <div class="py-4 justify-content-center text-center">
            <h2 class="homeHeader mb-3">How can we help?</h2>
            <div class="row">
                <div class="col-10 offset-1 col-md-8 offset-md-2">
                    <div class="row">
                        <div class="py-3 col-md-4">
                            <a type="button" class="btn btn-primary serviceCategoryButton h-100" href="./studentServices/studentServices-support.php">
                                <div class="row py-3">
                                    <div class="col-3 col-md-12 offset-1 offset-md-0">
                                        <svg xmlns="http://www.w3.org/2000/svg" height="72" width="72" viewBox="0 0 576 512">
                                            <!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2023 Fonticons, Inc.-->
                                            <path d="M64 32C28.7 32 0 60.7 0 96V416c0 35.3 28.7 64 64 64H512c35.3 0 64-28.7 64-64V96c0-35.3-28.7-64-64-64H64zm80 256h64c44.2 0 80 35.8 80 80c0 8.8-7.2 16-16 16H80c-8.8 0-16-7.2-16-16c0-44.2 35.8-80 80-80zm-32-96a64 64 0 1 1 128 0 64 64 0 1 1 -128 0zm256-32H496c8.8 0 16 7.2 16 16s-7.2 16-16 16H368c-8.8 0-16-7.2-16-16s7.2-16 16-16zm0 64H496c8.8 0 16 7.2 16 16s-7.2 16-16 16H368c-8.8 0-16-7.2-16-16s7.2-16 16-16zm0 64H496c8.8 0 16 7.2 16 16s-7.2 16-16 16H368c-8.8 0-16-7.2-16-16s7.2-16 16-16z"/>
                                        </svg>
                                    </div>
                                    <div class="col-7 col-md-12">
                                        <h4 class="homeHeader py-3 align-middle">Academic &amp;<br>Student Services</h4>
                                    </div>
                                    <div class="col">
                                        <p class="homeDesc">
                                            Get help with registration, billing, payments, financial aid, housing, campus card, and more.
                                        </p>
                                    </div>
                                </div>
                            </a>
                        ...
                        <div class="py-3 col-md-4">
                            <a type="button" class="btn btn-primary serviceCategoryButton h-100" href="./administrative/administrative-support.php">
                                <div class="row py-3">
                                    <div class="col-3 col-md-12 offset-1 offset-md-0">
                                    ...
                                    <div class="col-7 col-md-12">
                                        <h4 class="homeHeader py-3 align-middle">Administrative<br>Services</h4>
                                    </div>
                                    <div class="col">
                                        <p class="homeDesc">
                                            Get help with procurement, business and financial services, HR, shared services, and more.
                                        </p>
                                    </div>
                                </div>
                            </a>
                        ...
                        <div class="py-3 col-md-4">
                            <a type="button" class="btn btn-primary serviceCategoryButton h-100" href="./computingTechnology/computingTechnology-support.php">
                                <div class="row py-3">
                                    <div class="col-3 col-md-12 offset-1 offset-md-0">
                                    ...
                                    <div class="col-7 col-md-12">
                                        <h4 class="homeHeader py-3 align-middle">Computing &amp;<br>Technology</h4>
                                    </div>
                                    <div class="col">
                                        <p class="homeDesc">
                                            Get help with accounts, instructional support, computer requests, and other IT requests or issues.
                                        </p>
                                    </div>
                                </div>
                            </a>
        ...
        <div class="py-4 justify-content-center text-center">
            <div class="row">
                <div class="col-10 offset-1 col-md-8 offset-md-2">
                    <div class="d-flex px-0 py-0 justify-content-between justify-content-md-center">
                        <a type="button" class="me-2 btn btn-secondary" href="https://umbc.edu/go/help-open-requests">
                            View Open Requests
                        </a>
                        <a type="button" class="ms-2 btn btn-secondary" href="https://umbc.edu/go/help-request-history" >
                            Request History
                        </a>
                    </div>
                </div>
