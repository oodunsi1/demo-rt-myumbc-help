...
class veteransModule extends reqModule
{
    protected $queue = 1368;
    protected $boxProject = "rr_veterans_1368";

    protected $classHeader = "vtn";
    ...
    /*public function finish($queue="", $boxProject="")
    {
        ...
        $subject = FILTER_INPUT(INPUT_POST, $this->className . "Subject", FILTER_SANITIZE_STRING, FILTER_FLAG_NO_ENCODE_QUOTES);
